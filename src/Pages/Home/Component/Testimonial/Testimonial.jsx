...
const Testimonial = () => {
  return (
    <>
      <div className=" mb-8 mt-[130px] space-y-3">
      ...
      >
        <SwiperSlide>
          <div className=" mb-10 bg-[#ffffec] rounded-3xl w-[371px] p-6 space-y-5">
            ...
            <div className="avatar placeholder">
              <div className="bg-neutral text-neutral-content w-14 rounded-full">
                <span className="text-xl"><img src="https://t3.ftcdn.net/jpg/03/53/59/46/360_F_353594684_Ca3p9RIc3xgQ1Y6ff7Jk6nVe54v9NbpQ.jpg" alt="" /></span>
              </div>
            </div>
        ...
        <SwiperSlide>
          <div className=" bg-[#ffffec] rounded-3xl w-[371px] p-6 space-y-5">
            ...
            <div className="avatar placeholder">
              <div className="bg-neutral text-neutral-content w-14 rounded-full">
                <span className="text-xl"><img src="https://media.gettyimages.com/id/1384357158/photo/portrait-of-a-beautiful-mexican-woman.jpg?s=612x612&w=gi&k=20&c=1HfBFwGahEb6rPkGrSYHRD65_f4DZ16v8O7T7BJvmtE=" alt="" /></span>
              </div>
            </div>
            <div className=" flex flex-col">
        ...
        <SwiperSlide>
          <div className=" bg-[#ffffec] rounded-3xl w-[371px] p-6 space-y-5">
            <h1 className=" text-2xl font-semibold">A Partner in Health and
            Wellness</h1>
            <p className=" text-sm">
            ...
            <div className="avatar placeholder">
              <div className="bg-neutral text-neutral-content w-14 rounded-full">
                <span className="text-xl"><img src="https://photoheads.co.uk/wp-content/uploads/2020/05/headshot-with-client-testimonial.jpg" alt="" /></span>
              </div>
            </div>
            <div className=" flex flex-col">
        ...
        <SwiperSlide>
          <div className=" bg-[#ffffec] rounded-3xl w-[371px] p-6 space-y-5">
            ...
            <div className="avatar placeholder">
              <div className="bg-neutral text-neutral-content w-14 rounded-full">
                <span className="text-xl"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0_6Agi5pnn0cb_gve9Cmf5wWKrkUCc_9PVJHENU7SWjQqDbEKZmpd1_JplHX0ntjE1j0&usqp=CAU" alt="" /></span>
              </div>
            </div>
            <div className=" flex flex-col">
                <h3 className=" text-lg"><span className=" text-xl font-semibold">Sarah D,</span> IT Professional</h3>
